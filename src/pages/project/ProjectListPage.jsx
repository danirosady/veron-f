...
import { PROJECT_STATUS, PROJECT_STATUS_LABELS, COMMON_STATUS_OPTIONS } from '@/utils/constants';
...
export default function ProjectListPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (v) => {
        const variant = v === 'active' ? 'active' : v === 'completed' ? 'completed' : 'inactive';
        return <Badge variant={variant} size="sm">{titleCase(v)}</Badge>;
      },
    },
  ];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Projects"
        subtitle="Manage projects across companies"
        actions={
      ...
      <Card padding={false}>
        <DataTable
          ...
          emptyMessage="There are no projects matching your filters yet."
